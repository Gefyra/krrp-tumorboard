...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    <sch:title>f:Procedure/f:extension/f:value[x] 1</sch:title>
  ...
  <sch:pattern>
    <sch:title>f:Procedure/f:extension/f:value[x]/f:coding 1</sch:title>
    <sch:rule context="f:Procedure/f:extension/f:value[x]/f:coding">
      <sch:assert test="count(f:id) &lt;= 1">id: maximum cardinality of 'id' is 1</sch:assert>
  ...
  <sch:pattern>
    <sch:title>f:Procedure/f:complication/f:coding</sch:title>
